...
@Component({
  ...
  standalone: true,
  imports: [ MyButtonComponent, CommonModule, SubtitleComponent, QRCodeModule, MatIconModule, TitleComponent, LoadingComponent, ReactiveFormsModule, PlusButtonComponent ],
